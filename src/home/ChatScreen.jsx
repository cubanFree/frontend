...
export async function OpenChat(
  ...
  try {
      ...
      const response = await fetch(`https://alva-chats-server.mongo.cosmos.azure.com/open-chat/${id}`, {
          method: 'PATCH',
          headers: {
...
function ChatScreen() {
  ...
  useEffect(() => {
    ...
    fetch(`https://alva-chats-server.mongo.cosmos.azure.com/chat/${userId}`, { method: 'GET' })
